...
Run `npm run styleguide` for development. It will start Styleguidist in watch mode.
Or use `npm run styleguide:build` if you want to host your styleguide. 
You can check the build with `npm run serve:styleguide`

To Provide additional information to your components you can use the `.md` file which
is generated automatically for ne components.

Also your components prop-types and default are provided automatically like an
kind of JS Doc comments.
